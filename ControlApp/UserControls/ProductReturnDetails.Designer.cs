...
{
    partial class ProductReturnDetails
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            mainBs = new BindingSource(components);
            ...
            ((System.ComponentModel.ISupportInitialize)mainBs).BeginInit();
            ...
            flowLayoutPanel2.Size = new Size(382, 375);
            ...
            // mainBs
            // 
            mainBs.DataSource = typeof(Core.Entities.ProductReturnEntity);
            // 
            // productsBs
            // 
            ...
            // numericUpDown1
            // 
            numericUpDown1.DataBindings.Add(new Binding("Value", mainBs, "Count", true));
            ...
            label3.TabIndex = 0;
            label3.Text = "Дата возврата";
            // 
            // dateTimePicker1
            // 
            dateTimePicker1.DataBindings.Add(new Binding("Value", mainBs, "ReturnDate", true));
            ...
            label7.TabIndex = 0;
            label7.Text = "Причина возврата";
            // 
            // textBox7
            // 
            textBox7.DataBindings.Add(new Binding("Text", mainBs, "Reason", true));
            ...
            flowLayoutPanel5.Location = new Point(3, 307);
            ...
            label4.TabIndex = 0;
            label4.Text = "Примечания";
            // 
            // textBox1
            // 
            textBox1.DataBindings.Add(new Binding("Text", mainBs, "Additional", true, DataSourceUpdateMode.OnPropertyChanged));
            ...
            Size = new Size(396, 381);
            flowLayoutPanel2.ResumeLayout(false);
            flowLayoutPanel1.ResumeLayout(false);
            flowLayoutPanel1.PerformLayout();
            ((System.ComponentModel.ISupportInitialize)mainBs).EndInit();
